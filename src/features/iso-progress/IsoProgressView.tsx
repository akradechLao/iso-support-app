    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mx-auto max-w-[1540px]">
        <div className="mb-6 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-950">ISO Progress</h1>
            <p className="mt-1 text-sm text-slate-500">
              Requirement → Document → Audit → Finding → Risk → Action → Verification → Closure
            </p>
          </div>
        ...
        {/* Clause Tree */}
        <Panel title="Clause Coverage" subtitle="ISO requirement hierarchy with progress" className="mt-6">
                        ...
                        <div className="flex items-center gap-2">
                          {clause.childClauses.length > 0 && (
                            <span className="text-xs text-slate-400">
                              {clause.childClauses.length} sub-clauses
                            </span>
                          )}
                        </div>
                      </div>
